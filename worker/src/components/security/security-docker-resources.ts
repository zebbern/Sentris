...
> = {
  ...
  'sentris.semgrep.run': SECURITY_DOCKER_RESOURCE_HEAVY,
  'sentris.opengrep.run': SECURITY_DOCKER_RESOURCE_HEAVY,
  'sentris.codeql.run': SECURITY_DOCKER_RESOURCE_HEAVY,
  'sentris.jazzer-js.run': SECURITY_DOCKER_RESOURCE_HEAVY,
  'sentris.repository.files.extract': null,
  'sentris.github.repository.clone': null,
  'sentris.repository.manifest.extract': null,
  'sentris.npm.registry.intel': null,
  'sentris.npm.package.source': null,
