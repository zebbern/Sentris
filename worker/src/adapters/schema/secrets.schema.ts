...
export const secrets = pgTable(
  ...
  (table) => ({
    organizationIdx: index('secrets_organization_id_idx').on(table.organizationId),
  }),
);
...
export const secretVersions = pgTable(
  ...
  (table) => ({
    ...
    organizationIdx: index('secret_versions_organization_id_idx').on(table.organizationId),
  }),
);
