...
/** Clerk appearance configuration — simplified structural type to avoid the
 *  overly complex union generated by `ComponentProps<typeof UserButton>['appearance']`. */
...
const ClerkOrganizationSwitcherComponent = ({ appearance }: { appearance?: ClerkAppearance }) => (
  <OrganizationSwitcher
