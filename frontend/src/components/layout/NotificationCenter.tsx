...
export function NotificationCountBadge({
  ...
  return (
    <button
      type="button"
      className={cn(
        'absolute z-10 flex items-center justify-center rounded-full bg-destructive font-bold leading-none text-destructive-foreground shadow-sm ring-background',
        compact
          ? '-right-0 -top-0 h-3 min-w-3 px-0.5 text-[8px] ring-1'
          : '-right-1 -top-1 h-4 min-w-4 px-1 text-[10px] ring-2',
        className,
      )}
...
export function NotificationsPopover({
  ...
  return (
    <Popover open={open} onOpenChange={onOpenChange}>
      {children}
      <PopoverContent align="start" side={side} sideOffset={8} className="w-80 p-0">
