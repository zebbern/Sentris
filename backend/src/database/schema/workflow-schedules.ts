...
export const workflowSchedulesTable = pgTable(
  'workflow_schedules',
  {
  ...
  (table) => ({
    orgWorkflowIdx: index('workflow_schedules_org_workflow_idx').on(
      table.organizationId,
      table.workflowId,
    ),
    orgStatusIdx: index('workflow_schedules_org_status_idx').on(table.organizationId, table.status),
  }),
);
