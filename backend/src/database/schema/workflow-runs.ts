...
export const workflowRunsTable = pgTable(
  ...
  (table) => ({
    orgWorkflowCreatedAtIdx: index('workflow_runs_org_workflow_created_at_idx').on(
      table.organizationId,
      table.workflowId,
      table.createdAt,
    ),
    orgCreatedAtIdx: index('workflow_runs_org_created_at_idx').on(
      table.organizationId,
      table.createdAt,
    ),
    parentRunCreatedAtIdx: index('workflow_runs_parent_run_created_at_idx').on(
      table.parentRunId,
      table.createdAt,
    ),
