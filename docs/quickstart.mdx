---
title: "Quickstart"
description: "Get Sentris Flow running in 5 minutes"
---
...
- [just](https://github.com/casey/just) command runner (recommended but optional — `bun run` alternatives are available)
