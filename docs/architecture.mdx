...
|----------|-------------|----------|
| **security** | Security scanning and enumeration tools (24 components) | Subfinder, DNSX, Nuclei, Naabu, HTTPx, TruffleHog, Trivy, Semgrep, Katana, AbuseIPDB, VirusTotal, YARA |
