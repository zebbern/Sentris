...
- [ ] **Step 1: Write failing catalog and integration expectations**
...
- [ ] **Step 3: Implement and export one provider catalog**
...
- [ ] **Step 4: Wire the Z.AI endpoint without changing compatibility model fallbacks**
...
- [ ] **Step 3: Extend the closed editor union and component descriptors**
...
- [ ] **Step 4: Document and generate the catalog contract**
...
- [ ] **Step 1: Write failing metadata-driven resolver tests**
...
- [ ] **Step 2: Write failing canonical-versus-legacy agent tests**
...
- [ ] **Step 4: Implement contract-driven resolution**
...
- [ ] **Step 5: Implement explicit agent credential precedence**
...
- [ ] **Step 6: Move the official seed placeholder into the contract**
...
- [ ] **Step 7: Run focused tests, compile check, and typecheck**
...
- [ ] **Step 1: Move the existing per-server MCP calculation with tests unchanged**
...
- [ ] **Step 2: Write failing agent-readiness tests**
...
- [ ] **Step 3: Write failing conditional-query tests**
...
- [ ] **Step 5: Implement pure readiness decisions**
...
- [ ] **Step 6: Add skipToken-based query gating**
...
- [ ] **Step 1: Write failing metadata-routing and hiding tests**
...
- [ ] **Step 4: Make ConfigPanel metadata-driven**
...
- [ ] **Step 5: Implement complete provider/model/credential editing**
...
- [ ] **Step 6: Hide semantic and migration-only inputs consistently**
...
- [ ] **Step 2: Write failing ValidationDock integration tests**
...
- [ ] **Step 4: Implement a graph-only adapter**
...
- [ ] **Step 5: Add readiness issues without adding a run-confirmation nuisance**
...
- [ ] **Step 1: Write failing defensive parser tests**
...
- [ ] **Step 3: Implement defensive graph parsing**
...
- [ ] **Step 4: Adapt to the Task 4 domain**
...
- [ ] **Step 1: Extend query mocks and write failing modal tests**
...
- [ ] **Step 3: Derive all remote data through TanStack Query**
...
- [ ] **Step 4: Render one compact shared readiness block**
...
- [ ] **Step 5: Align button state with readiness**
...
- [ ] **Step 6: Run focused modal verification**
...
- [ ] **Step 1: Run each focused automated suite once**
...
- [ ] **Step 2: Run affected typechecks, targeted lint, and generated-output checks**
...
- [ ] **Step 3: Check and start the selected local instance**
...
- [ ] **Step 4: Browser-verify the generic agent editor**
...
- [ ] **Step 5: Browser-verify template launch readiness**
...
- [ ] **Step 6: Run one real Gemini npm investigation**
...
- [ ] **Step 7: Review the final diff and close the plan**
