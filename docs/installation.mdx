...
```bash
git clone https://github.com/sentris/studio.git
cd studio
just init
```
...
- Check [GitHub Issues](https://github.com/sentris/studio/issues) for similar problems
- Review logs with `just dev logs` for error details
- Email support at [support@sentris.ai](mailto:support@sentris.ai)
