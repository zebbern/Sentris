...
**Sentris Flow** is the open source, no-code security automation platform for security teams. Design reusable security workflows, see every run unfold live, and keep humans in the loop with opinionated guardrails.
...
- **Support** – [support@sentris.ai](mailto:support@sentris.ai)
- **GitHub** – [github.com/sentris/studio](https://github.com/sentris/studio)
